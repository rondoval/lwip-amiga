...
/* Host test config for the LWIP_TCP_URG regression tests: the TCP-relevant
 * parts of lwip-amiga/port/amiga/include/lwipopts.h (NO_SYS, core TCP
 * sizing) with urgent-data support enabled. Mirrors test/fuzz/lwipopts.h
 * minus the fuzz oracle allocator. */
#ifndef URG_LWIPOPTS_H
#define URG_LWIPOPTS_H
